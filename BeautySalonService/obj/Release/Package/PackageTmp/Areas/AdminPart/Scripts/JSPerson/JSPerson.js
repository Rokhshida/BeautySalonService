...
app.controller('MyCtrl', function ($scope, $compile, $http) {
    ...
    $scope.dz_PersImageOptions = {
        url: '/AdminPart/CMSPerson/GetSiteSettingImageFiles',
    ...
    $scope.ShowLoadingAngular = function (PageNum, PageSize, Status) {
        ...
        var response = $http({
            method: "post",
            url: "/AdminPart/CMSPerson/GetPersonWithPage",
            params: {
                CurrentPage: PageNum,
                PageSize: PageSize,
                TxtPersonSearch:""
    ...
    FuncUpdateInDB = function () {
        ...
        if (confirm("آیا می خواهید ذخیره کنید؟")) {
            ...
            $.ajax({
                ...
                type: "post",
                url: "/AdminPart/CMSPerson/UpdatePerson",
                data: {
                    ObjPerson: VarNewRec
                },
    ...
    $scope.FuncDelete = function (ID) {
        ...
        if (confirm("آیا از حذف اطمینان دارید؟")) {
            ...
            var getData = $http.get("/AdminPart/CMSPerson/DeletePerson?ID=" + ID);
