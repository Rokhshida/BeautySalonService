...
app.controller('MyCtrl', function ($scope, $compile, $http) {
    ...
    $scope.dz_PersImageOptions = {
        url: '/AdminPart/CMSService/GetServiceImageFile',
    ...
    function FuncShowArticles() {

        var getData = $http.get("/AdminPart/CMSArticle/GetArticles");
        getData.then(function (VarMessage) {
            $scope.ListAllArticle = VarMessage.data;
    ...
    function FuncSave() {
        ...
        if (confirm("آیا می خواهید ذخیره کنید؟")) {
           ...
           // alert($('#DrpArticle').val());
            $.ajax({

                type: "post",
                url: "/AdminPart/CMSService/SaveService",
                data: {
                    ObjService: VarNewRec
                },
    ...
    FuncUpdateInDB = function () {
        ...
        if (confirm("آیا می خواهید ذخیره کنید؟")) {
            ...
            $.ajax({
                ...
                type: "post",
                url: "/AdminPart/CMSService/UpdateService",
                data: {
                    ObjService: $scope.formData
                },
    ...
    $scope.FuncDelete = function (ID) {
        ...
        if (confirm("آیا از حذف اطمینان دارید؟")) {
            ...
            var getData = $http.get("/AdminPart/CMSService/DeleteService?ID=" + ID);
